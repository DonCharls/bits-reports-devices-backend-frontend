                                ...
                                <div className="space-y-4 pt-2 border-t mt-4">
                                    <div className="w-full md:w-1/2 space-y-2">
                                        ...
                                        <Input 
                                            ...
                                            type="number" 
                                            min={15}
                                            value={config.globalMinCheckoutMinutes}
                                            onChange={(e) => {
                                                const raw = parseInt(e.target.value) || 0;
                                                setConfig({ ...config, globalMinCheckoutMinutes: raw });
                                            }}
                                        />
                            ...
                            <div className="space-y-4 rounded-md border p-4 bg-muted/20 md:col-span-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <Switch 
                                        ...
                                        checked={config.logBufferMaintenanceEnabled}
                                        onCheckedChange={(c) => setConfig({ ...config, logBufferMaintenanceEnabled: c })} 
                                    />
                                </div>
                                <p className="text-xs text-muted-foreground leading-relaxed">
                                ...
                                {config.logBufferMaintenanceEnabled && (
                                    <div className="space-y-4 pt-2 border-t mt-4 flex flex-col md:flex-row gap-6">
                                        <div className="flex flex-col gap-2 w-full md:w-1/2">
                                            ...
                                            <select
                                                ...
                                                value={config.logBufferMaintenanceSchedule}
                                                onChange={(e) => setConfig({ ...config, logBufferMaintenanceSchedule: e.target.value as 'daily' | 'weekly' | 'monthly' })}
                                            >
                                        ...
                                        <div className="flex flex-col gap-2 w-full md:w-1/2">
                                            ...
                                            <Input 
                                                ...
                                                min={0}
                                                max={23}
                                                value={config.logBufferMaintenanceHour}
                                                onChange={(e) => {
                                                    const raw = parseInt(e.target.value) || 0;
                                                    const clamped = Math.min(23, Math.max(0, raw));
                                                    setConfig({ ...config, logBufferMaintenanceHour: clamped });
                                                }}
                                            />
